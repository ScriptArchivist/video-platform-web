...
export default function LoginPage() {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden p-6">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,_rgba(15,23,42,0.08),_transparent_35%),linear-gradient(180deg,_#f8fafc_0%,_#eef2ff_100%)]" />

      <div className="relative grid w-full max-w-5xl overflow-hidden rounded-[32px] border border-slate-200 bg-white/90 shadow-2xl backdrop-blur lg:grid-cols-[1.05fr_0.95fr]">
            ...
            <div>
              ...
              <div className="mt-14">
                ...
                <p className="mt-5 max-w-md text-sm leading-7 text-slate-300">
                  Upload content, monitor processing, create RTMP live sessions,
                  and preview HLS playback through a single internal frontend.
                </p>
              </div>
            </div>
        ...
        <div className="px-6 py-8 sm:px-10 sm:py-10">
          <div className="mx-auto w-full max-w-md">
            ...
            <form onSubmit={handleSubmit} className="mt-8 space-y-5">
              ...
              <button type="submit" disabled={isPending} className="app-btn-primary w-full">
